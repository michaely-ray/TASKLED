...
{
#if CONFIG_LWIP_PPP_PAP_SUPPORT && defined(CONFIG_MODEM_PPP_AUTH_USERNAME) && defined(CONFIG_MODEM_PPP_AUTH_PASSWORD)
    esp_netif_auth_type_t auth_type = NETIF_PPP_AUTHTYPE_PAP;
#elif CONFIG_LWIP_PPP_CHAP_SUPPORT && defined(CONFIG_MODEM_PPP_AUTH_USERNAME) && defined(CONFIG_MODEM_PPP_AUTH_PASSWORD)
    esp_netif_auth_type_t auth_type = NETIF_PPP_AUTHTYPE_CHAP;
#elif defined(CONFIG_MODEM_PPP_AUTH_USERNAME) && defined(CONFIG_MODEM_PPP_AUTH_PASSWORD)
...
#if defined(CONFIG_MODEM_PPP_AUTH_USERNAME) && defined(CONFIG_MODEM_PPP_AUTH_PASSWORD)
